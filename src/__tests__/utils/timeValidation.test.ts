/**
 * ============================================================================
 * UTILITY TESTS - Time Validation System
 * ============================================================================
 * 
 * Comprehensive tests for time entry validation utilities.
 * Tests business rules, rounding logic, and validation constraints.
 * 
 * 🧪 TEST INSTRUCTIONS:
 * 1. Run: npm test -- --testPathPattern="utils/timeValidation"
 * 2. Pure utility function testing - no external dependencies
 * 3. Focus on business rule accuracy and edge cases
 * 4. Tests ERP-critical time validation logic
 * 
 * 🔧 FUNCTIONS TESTED:
 * - TimeValidator class: Main validation engine
 * - validateTimeEntry(): Entry-level validation
 * - roundHours(): Time rounding business rules
 * - Date/time constraint validation
 * 
 * 🛠️ BUSINESS RULES TESTED:
 * - Minimum time increments (0.25 hour)
 * - Maximum daily hours (8-12 hours)
 * - Overtime calculation thresholds
 * - Date range validation constraints
 * - User role-based validation rules
