...
exports.deleteTaskPhotoV2 = exports.uploadTaskPhotoV2 = void 0;
 ...
 */
exports.uploadTaskPhotoV2 = (0, https_1.onCall)({
    cors: true,
    maxInstances: 10
}, async (request) => {
    ...
    if (!taskId || !photoId || !base64Data) {
        throw new https_1.HttpsError('invalid-argument', 'Missing required fields: taskId, photoId, or base64Data');
    }
    try {
        ...
        throw new https_1.HttpsError('internal', 'Upload failed', error instanceof Error ? error.message : 'Unknown error');
    }
});
/**
 * Callable function to delete task photos
 */
exports.deleteTaskPhotoV2 = (0, https_1.onCall)({
    cors: true,
    maxInstances: 10
}, async (request) => {
    // Verify authentication
    ...
    if (!taskId || !photoId) {
        throw new https_1.HttpsError('invalid-argument', 'Missing required fields: taskId or photoId');
    }
    try {
        // Delete from storage
        const bucket = admin.storage().bucket();
        ...
        throw new https_1.HttpsError('internal', 'Delete failed', error instanceof Error ? error.message : 'Unknown error');
    }
});
