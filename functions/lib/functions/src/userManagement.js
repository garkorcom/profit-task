...
exports.initializeFirstAdmin = exports.onUserProfileUpdate = exports.refreshUserCustomClaims = exports.deactivateUser = exports.updateUserHourlyRate = exports.updateUserRole = exports.onUserCreate = void 0;
...
exports.initializeFirstAdmin = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        if (!ownersQuery.empty) {
            throw new functions.https.HttpsError('already-exists', 'System already has an owner. Use regular role update functions.');
        }
