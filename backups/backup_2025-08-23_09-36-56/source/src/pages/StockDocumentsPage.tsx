...
import { Product, getProductsStream, StockDocument, StockDocumentLine, getStockDocumentsStream, addStockDocument, updateStockDocument, postStockDocument, deleteStockDocument } from '../api/productApi';
    ...
    <Box>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} maxWidth="md" fullWidth>
        ...
        <DialogContent>
          ...
          <TextField label="Обоснование / Примечание" value={form.justification || form.comment || ''} onChange={(e)=>setForm({...form, justification: e.target.value, comment: e.target.value})} fullWidth multiline rows={2} sx={{ mt: 2 }} />
        </DialogContent>
        <DialogActions>
