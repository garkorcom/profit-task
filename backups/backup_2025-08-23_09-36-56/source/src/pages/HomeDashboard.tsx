...
const HomeDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const unsubTimesheet = employeeData ? api.getTimesheetsByEmployeeStream(employeeData.id, (data: TimesheetEntry[]) => setTimesheet(data)) : undefined;
    return () => {
      unsubProjects && unsubProjects();
      unsubTasks && unsubTasks();
      unsubTimesheet && unsubTimesheet();
    };
  }, [currentUser, employeeData, loading]);
  ...
  const handleCreateEstimate = () => {
    ...
    navigate(`/projects/${selectedProjectId}/estimates/new/constructor`);
  };
