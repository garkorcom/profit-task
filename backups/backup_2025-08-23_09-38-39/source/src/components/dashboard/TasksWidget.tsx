...
import { Typography, Card, CardContent, List, ListItem, ListItemText, Chip, Button, Skeleton, Box } from '@mui/material';
                ...
                <ListItemText
                  ...
                  secondary={
                    <Box component="span" display="flex" alignItems="center" gap={1}>
                      {task.projectName && <Chip label={task.projectName} size="small" />}
                      {task.contractorName && <span>{task.contractorName}</span>}
                    </Box>
                  }
