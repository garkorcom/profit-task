...
const ReferencesPage: React.FC = () => {
  ...
  const references: ReferenceItem[] = [
    ...
    {
      title: 'Сотрудники',
      description: 'Управление персоналом и табелями',
      icon: <PeopleIcon />,
      path: '/employees',
      color: '#ff6f00'
    },
    {
      ...
      description: 'Привязка Google-аккаунтов к сотрудникам',
      icon: <LinkIcon />,
      path: '/employee-auth-linking',
      color: '#009688'
    },
    {
      title: 'Складские документы',
      description: 'Приход и расход через проведение документов',
      icon: <InventoryIcon />,
