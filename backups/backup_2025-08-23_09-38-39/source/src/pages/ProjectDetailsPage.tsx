...
const ProjectDetailsPage: React.FC = () => {
  const { projectId: projectName } = useParams<{ projectId: string }>(); // Rename for clarity
  ...
  useEffect(() => {
    ...
    const unsubscribe = api.getProjectStream(projectName, (data: Project | null) => {
      if (data) {
        setProject(data);
      } else {
